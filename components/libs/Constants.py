...
derivat_constants.window.pricing.input_dimensions.strike_start = 'Start'
derivat_constants.window.pricing.input_dimensions.strike_step = 'Step'
derivat_constants.window.pricing.input_dimensions.strike_stop = 'Stop' 
derivat_constants.window.pricing.input_dimensions.expirations = 'Expirations (days)'
derivat_constants.window.pricing.input_dimensions.expiration_start = 'Start'
