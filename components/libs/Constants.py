...
constants.window.messages.exit.description = (
    "Close derivat? Any unsaved valuation configuration will be lost."
)
...
constants.backend.serialization.path.setting.interest_rate = (
    "valuation.factors.interest_rate"
)
